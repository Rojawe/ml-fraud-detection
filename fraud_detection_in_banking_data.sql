...
--
-- Host: localhost
-- Generation Time: Jul 31, 2023 at 01:14 PM
...
--
-- Database: `fraud_detection_in_banking_data`
--
CREATE DATABASE IF NOT EXISTS `fraud_detection_in_banking_data` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fraud_detection_in_banking_data`;
...
('tri7tf2avfcqoex71zns6wwaeel10tyu', 'eyJ1c2VyaWQiOjJ9:1qQSIq:L56vB5G6s1SDTmuG3VbsPg8vfTwMDkf0zZRfy50luJg', '2023-08-14 12:47:12.133606'),
...
('x1xqm7mialps4kaqb261ryadu776pk5d', 'eyJ1c2VyaWQiOjF9:1qQQ8V:vmao44DRISctz-xOoc-8s1LFQHmedp4zKG6NCj15AjM', '2023-08-14 10:28:23.541176'),
...
(21, 'Artificial Neural Network-ANN', '52.63157894736842'),
(22, 'Logistic Regression', '52.0'),
(23, 'LightGBM', '52.63157894736842');
...
(14, 'No Fraud Found', '60.0'),
(15, 'Fraud Found', '40.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_fraud_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_fraud_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `customer` varchar(300) NOT NULL,
  `age` varchar(300) NOT NULL,
  `gender` varchar(300) NOT NULL,
  `zipcodeOri` varchar(300) NOT NULL,
  `merchant` varchar(300) NOT NULL,
  `zipMerchant` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_predict_fraud_detection`
--

INSERT INTO `remote_user_predict_fraud_detection` (`id`, `Fid`, `customer`, `age`, `gender`, `zipcodeOri`, `merchant`, `zipMerchant`, `category`, `amount`, `Type`, `Date_Time`, `Prediction`) VALUES
(1, '172.217.10.42-10.42.0.151-443-53401-6', 'C281893917', '50', 'M', '28007', 'M1823072687', '28007', 'es_transportation', '365558.2', 'CASH_IN', '2019-12-16 02:41:53+09', 'No Fraud Found'),
(4, '151.101.1.140-10.42.0.211-443-34099-6', 'C1355357191', '31', 'F', '28007', 'M480139044', '28007', 'es_health', '57746.41', 'PAYMENT', '2019-12-16 03:03:56+09', 'Fraud Found'),
(5, '10.42.0.211-54.192.38.65-58618-443-6', 'C1394428191', '39', 'F', '28007', 'M1823072687', '28007', 'es_transportation', '10941.08', 'TRANSFER', '2019-12-17 18:48:30+09', 'Fraud Found'),
(6, '10.42.0.42-23.194.181.192-47985-443-6', 'C30336615', '32', 'M', '28007', 'M348934600', '28007', 'es_transportation', '31339.42', 'TRANSFER', '2019-12-17 04:06:47+09', 'No Fraud Found'),
(7, '10.42.0.211-10.42.0.1-34485-53-17', 'C1622016247', '36', 'F', '28007', 'M1823072687', '28007', 'es_transportation', '4435.33', '2019-12-16 05:43:20+09', 'TRANSFER', 'No Fraud Found');
